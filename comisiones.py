...
# Form implementation generated from reading ui file 'comisiones.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 405, 18))
        ...
        MainWindow.setTabOrder(self.trabajador, self.nota)
        MainWindow.setTabOrder(self.nota, self.monto)
        MainWindow.setTabOrder(self.monto, self.agregar)
        MainWindow.setTabOrder(self.agregar, self.cancelar)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Registro de comisión"))
        ...
        self.nota.setToolTip(_translate("MainWindow", "<html><head/><body><p>Es obligartorio para agregar la variación que realice una nota. Todo monto que se otorgue por esta vía será computado como salario cotizable para la TSS, el impuesto sobre la renta y base de cálculo para el cálculo de prestaciones laborales y derechos adquiridos.</p></body></html>"))
