...
# Form implementation generated from reading ui file 'indemnizaciones.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tipo = QtWidgets.QComboBox(self.groupBox)
        ...
        self.tipo.addItem("")
        self.tipo.addItem("")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.tipo)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.monto)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Registro de indemnizaciones"))
        ...
        self.label_4.setText(_translate("MainWindow", "Tipo de indemnización"))
        self.tipo.setItemText(0, _translate("MainWindow", "Enfermedad común"))
        self.tipo.setItemText(1, _translate("MainWindow", "Accidente no laboral"))
        self.tipo.setItemText(2, _translate("MainWindow", "Maternidad"))
        self.tipo.setItemText(3, _translate("MainWindow", "Accidente laboral"))
        self.tipo.setItemText(4, _translate("MainWindow", "Otros"))
        self.label_6.setText(_translate("MainWindow", "Descripción:"))
        self.nota.setToolTip(_translate("MainWindow", "<html><head/><body><p>Es obligartorio para agregar la variación que realice una nota. Todo monto que se otorgue por esta vía será reportado a la TSS a través de los TXT.</p></body></html>"))
